                    ...
                    <form   id="jobForm" >
                        ...
                        <table class="btm">
                            ...
                            <tr>
                                ...
                                <td>职位名称</td>
                                <td>
                                    <input type="text" placeholder="请输入职位名称，如：产品经理" value="${zhiwei.xiaoname}" name="name" id="name">
                                </td>
                            </tr>
                            </tbody></table>
                        ...
                        <table class="btm">
                            <tbody><tr>
                                ...
                                <td>
                                    <ul class="profile_radio clearfix reset">
                                        <li>
                                            全职<em></em>
                                            <input type="radio" name="xingzhi" value="${zhiwei.xingzhi}">
                                        </li>
                                        <li>
                                            兼职<em></em>
                                            <input type="radio" name="xingzhi" value="${zhiwei.xingzhi}">
                            ...
                            <tr>
                                ...
                                <td>
                                    <div class="salary_range">
                                        <div>
                                            <input type="text" placeholder="最低月薪" value="${zhiwei.xinzi}" id="xinzi" name="xinzi">
                                            <span>k</span>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>工作城市</td>
                                <td>
                                    <input type="text" placeholder="请输入工作城市，如：北京" value="${zhiwei.city}" name="city" id="city">
                                </td>
                            </tr>
                            </tbody></table>
                        ...
                        <table class="btm">
                            <tbody><tr>
                                ...
                                <td width="85">职位诱惑</td>
                                <td>
                                    <input type="text" placeholder="20字描述该职位的吸引力，如：福利待遇、发展前景等" value="${zhiwei.youhuo}" name="youhuo" class="input_520" id="positionAdvantage">
                                </td>
                            </tr>
                            </tbody></table>
