        ...
        <div class="content">
            <dl class="company_center_content">
                ...
                <dd>
                    ...
                    <form   id="jobForm" >
                        <input type="hidden" value="${laGouComSession.comid}" name="id">
                        <input type="hidden" value="create" name="preview">
                        <input type="hidden" value="${laGouComSession.comid}" name="comid">
                        ...
                        <table class="btm">
                            <tbody><tr>
                                ...
                                <td width="85">职位类别</td>
                                <td>
                                    <input type="text" id="zhiweigreatid" value="" name="zhiweigreatid">
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table class="btm">
                            <tbody><tr>
                                ...
                                <td>
                                    <ul class="profile_radio clearfix reset">
                                        <li>
                                            全职<em></em>
                                            <input type="radio" name="xingzhi" value="全职">
                                        </li>
                                        <li>
                                            兼职<em></em>
                                            <input type="radio" name="xingzhi" value="兼职">
                                        </li>
                                        <li>
                                            实习<em></em>
                                            <input type="radio" name="xingzhi" value="实习">
                                        </li>
                                    </ul>
                                </td>
                            </tr>
                            <tr>
                                ...
                                <td>
                                    <div class="salary_range">
                                        <div>
                                            <input type="text" placeholder="最低月薪" value="" id="xinzi" name="xinzi">
                                            <span>k</span>
                                        </div>
                                    </div>
                                </td>
                            ...
                            <tr>
                                ...
                                <td>工作城市</td>
                                <td>
                                    <input type="text" placeholder="请输入工作城市，如：北京" value="上海" name="city" id="city">
                                </td>
                            </tr>
                            </tbody></table>
                        ...
                        <table class="btm">
                            <tbody><tr>
                                ...
                                <td width="85">工作经验</td>
                                <td>
                                    <input type="hidden" id="experience" value="" name="jingyan">
                            ...
                            <tr>
                                ...
                                <td>学历要求</td>
                                <td>
                                    <input type="hidden" id="education" value="" name="xueli">
                        ...
                        <table class="btm">
                            <tbody><tr>
                                ...
                                <td width="85">职位诱惑</td>
                                <td>
                                    <input type="text" placeholder="20字描述该职位的吸引力，如：福利待遇、发展前景等" value="" name="youhuo" class="input_520" id="positionAdvantage">
                                </td>
                            </tr>
                            </tbody></table>
                        ...
                        <table>
                            <tbody><tr>
                                <td width="25"><span class="redstar">*</span></td>
                                <td colspan="2">
                                    接收简历邮箱： <span id="receiveEmailVal">admin@163.com</span>
...
<script>
        ...
        $("#jobPreview").click(function () {
            $.ajax({
                url:"<%=request.getContextPath()%>/zhiweiController/savezhiwei.do",
                type:"post",
