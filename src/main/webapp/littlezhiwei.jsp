...
<table class="table table-striped table-bordered table-hover" id="little-table" >
</table>
...
<script type="text/javascript">
    ...
    //查询
    $("#little-table").bootstrapTable({
        url: "<%=request.getContextPath()%>/zhiweiController/querylittlezw.do",
        striped: true,
        search: true,
