...
<html>
<head>
    </script><script type="text/javascript" async="" src="style/js/conversion.js"></script><script src="style/js/allmobilize.min.js" charset="utf-8" id="allmobilize"></script>
            ...
            <div class="content_l">
                ...
                <div class="profile_box" id="expectJob">
                    ...
                    <div class="expectEdit dn">
                        <form id="button1">
                            <table>
                                <tbody><tr>
                                    <input type="hidden"  value="1" name="jid">
                                    <td>
                                        <input type="hidden" id="expectCity" value="" name="qiwangchengshi">
                                    ...
                                    <td>
                                        <ul class="profile_radio clearfix reset">
                                            <li class="current">
                                                全职<em></em>
                                                <input type="radio" checked="" name="qiwangzhiye" value="全职">
                                            </li>
                                            <li>
                                                兼职<em></em>
                                                <input type="radio" name="qiwangzhiye" value="兼职">
                                            </li>
                                            <li>
                                                实习<em></em>
                                                <input type="radio" name="qiwangzhiye" value="实习">
                                            </li>
                                        </ul>
                                    </td>
                                </tr>
                                <tr>
                                    <td>
                                        <input type="text" placeholder="期望职位，如：产品经理" value="" name="qiwangzhiwei" id="expectPosition">
                                    </td>
                                    <td>
                                        <input type="hidden" id="expectSalary" value="" name="qiwangyuexin">
                                ...
                                <tr>
                                    <td colspan="2">
                                        <input type="button" onclick="aa(this)" value="保 存" name="button1" class="btn_profile_save">
                ...
                <div class="profile_box" id="workExperience">
                    ...
                    <div class="experienceShow dn">
                        <form id="button2" class="experienceForm borderBtm dn">
                            <input type="hidden"  value="1" name="jid">
                            <table>
                                <tbody><tr>
                                    <td valign="top">
                                    ...
                                    <td>
                                        <input type="text" placeholder="公司名称" name="gongzuogongsimingcheng" class="companyName">
                                    </td>
                                    <td valign="top">
                                        <span class="redstar">*</span>
                                    </td>
                                    <td>
                                        <input type="text" placeholder="职位名称，如：产品经理" name="gongzuozhiweimingcheng" class="positionName">
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top">
                                    ...
                                    <td>
                                        <div class="fl">
                                            <input type="hidden" class="companyYearStart" value="" name="gongzuokaishinianfen">
                                        ...
                                        <div class="fl">
                                            <input type="hidden" class="companyMonthStart" value="" name="gongzuokaishiyuefen">
                                    ...
                                    <td>
                                        <div class="fl">
                                            <input type="hidden" class="companyYearEnd" value="" name="gongzuojiesunainfen">
                                        ...
                                        <div class="fl">
                                            <input type="hidden" class="companyMonthEnd" value="" name="gongzuojiesuyuefen">
                                ...
                                <tr>
                                    <td></td>
                                    <td colspan="3">
                                        <input type="button" onclick="aa(this)" value="保 存" name="button2" class="btn_profile_save">
                                        <a class="btn_profile_cancel" href="javascript:;">取 消</a>
                                    </td>
                                </tr>
                                </tbody></table>
                    ...
                    <div class="experienceEdit dn">
                        <form class="experienceForm" id="button3">
                            <table>
                                <tbody><tr>
                                    <td valign="top">
                                        <input type="hidden"  value="1" name="jid">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <div class="fl">
                                            <input type="hidden" class="companyYearEnd" value="" name="gongzuojiesunianfen">
                                            <input type="button" value="结束年份" class="profile_select_139 profile_select_normal select_companyYearEnd">
                                            <div class="box_companyYearEnd  boxUpDown boxUpDown_139 dn" style="display: none;">
                                                <ul>
                                                    <li>至今</li>
                                ...
                                <tr>
                                    <td></td>
                                    <td colspan="3">
                                        <input type="button" onclick="aa(this)" value="保 存" name="button3" class="btn_profile_save">
                                        <a class="btn_profile_cancel" href="javascript:;">取 消</a>
                                    </td>
                                </tr>
                                </tbody></table>
                ...
                <div class="profile_box" id="projectExperience">
                    ...
                    <div class="projectEdit dn">
                        <form class="projectForm" id="button4">
                            <table>
                                <tbody><tr>
                                    <td valign="top">
                                        <span class="redstar">*</span>
                                    ...
                                    <td>
                                        <input type="hidden"  value="1" name="jid">
                                        <input type="text" placeholder="项目名称" name="xiangmumingcheng" class="projectName">
                                    </td>
                                    <td valign="top">
                                        <span class="redstar">*</span>
                                    </td>
                                    <td>
                                        <input type="text" placeholder="担任职务，如：产品负责人" name="xiangmuzhiwu" class="thePost">
                                    </td>
                                </tr>
                                <tr>
                                    <td valign="top">
                                    ...
                                    <td>
                                        <div class="fl">
                                            <input type="hidden" class="projectYearStart" value="" name="xiangmukaishinianfen">
                                        ...
                                        <div class="fl">
                                            <input type="hidden" class="projectMonthStart" value="" name="xiangmukaishinianfen">
                                    ...
                                    <td>
                                        <div class="fl">
                                            <input type="hidden" class="projectYearEnd" value="" name="xiangmujiesunianfen">
                                        ...
                                        <div class="fl">
                                            <input type="hidden" class="projectMonthEnd" value="" name="xiangmujiesuyuefen">
                                ...
                                <tr>
                                    <td valign="top"></td>
                                    <td colspan="3">
                                        <textarea class="projectDescription s_textarea" name="xiangmumiaosu" placeholder="项目描述"></textarea>
                                ...
                                <tr>
                                    <td valign="top"></td>
                                    <td colspan="3">
                                        <input type="button"  onclick="aa(this)"value="保 存" name="button4" class="btn_profile_save">
                                        <a class="btn_profile_cancel" href="javascript:;">取 消</a>
                                    </td>
                                </tr>
                                </tbody></table>
                ...
                <div class="profile_box" id="educationalBackground">
                    ...
                    <div class="educationalShow dn">
                        <form class="educationalForm borderBtm dn" id="button5">
                            <table>
                                <tbody><tr>
                                    <td valign="top">
                                        <span class="redstar">*</span>
                                    ...
                                    <td>
                                        <input type="hidden"  value="1" name="jid">
                                        <input type="text" placeholder="学校名称" name="xuexiaomingcheng" class="schoolName">
                                    </td>
                                    <td valign="top">
                                        <span class="redstar">*</span>
                                    </td>
                                    <td>
                                        <input type="hidden" class="degree" value="" name="xueli">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <input type="text" placeholder="专业名称" name="zhuanyemingcheng" class="professionalName">
                                    </td>
                                    <td valign="top">
                                        <span class="redstar">*</span>
                                    </td>
                                    <td>
                                        <div class="fl">
                                            <input type="hidden" class="schoolYearStart" value="" name="xuexiaokaishinianfen">
                                        ...
                                        <div class="fl">
                                            <input type="hidden" class="schoolYearEnd" value="" name="xuexiaojiesunianfen">
                                ...
                                <tr>
                                    <td></td>
                                    <td colspan="3">
                                        <input type="button" onclick="aa(this)" value="保 存"  name="button5"class="btn_profile_save">
                                        <a class="btn_profile_cancel" href="javascript:;">取 消</a>
                                    </td>
                                </tr>
                                </tbody></table>
                    ...
                    <div class="educationalEdit dn">
                        <form class="educationalForm" id="button6">
                            <table>
                                <tbody><tr>
                                    <td valign="top">
                                        <span class="redstar">*</span>
                                ...
                                <tr>
                                    <td></td>
                                    <td colspan="3">
                                        <input type="button" value="保 存" onclick="aa(this)" name="button6"class="btn_profile_save">
                                        <a class="btn_profile_cancel" href="javascript:;">取 消</a>
                                    </td>
                                </tr>
                                </tbody></table>
                ...
                <div class="profile_box" id="selfDescription">
                    ...
                    <div class="descriptionEdit dn">
                        <form class="descriptionForm" id="button7">
                            <table>
                                <tbody><tr>
                                    <td colspan="2">
                                        <input type="hidden"  value="1" name="jid">
                                        <textarea class="selfDescription s_textarea" name="ziwojieshao" placeholder=""></textarea>
                                        <div class="word_count">你还可以输入 <span>500</span> 字</div>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="2">
                                        <input type="button" onclick="aa(this)" value="保 存" name="button7" class="btn_profile_save">
                                        <a class="btn_profile_cancel" href="javascript:;">取 消</a>
                                    </td>
                                </tr>
                                </tbody></table>
                ...
                <!--                         <form class="workForm" name="button111"> -->
                <!--                             <table> -->
                <!--                                 <tbody><tr> -->
                <!--                                     <td> -->
                <!--                                         <input type="hidden"  value="1" name="jid"> -->
                <!--                                         <input type="text" placeholder="请输入作品链接" name="xiangmulujing" class="workLink"> -->
                <!--                                     </td> -->
                <!--                                 </tr> -->
                <!--                                 <tr> -->
                <!--                                     <td> -->
                <!--                                         <textarea maxlength="100" class="workDescription s_textarea" name="zuopinshuoming" placeholder="请输入说明文字"></textarea> -->
                <!--                                         <div class="word_count">你还可以输入 <span>100</span> 字</div> -->
                <!--                                     </td> -->
                <!--                                 </tr> -->
                <!--                                 <tr> -->
                <!--                                     <td> -->
                <!--                                         <input type="button" onclick="aa(this)" value="保 存" name="button111" class="btn_profile_save"> -->
                <!--                                         <a class="btn_profile_cancel" href="javascript:;">取 消</a> -->
                <!--                                     </td> -->
                <!--                                 </tr> -->
                <!--                                 </tbody></table> -->
...
<script type="text/javascript">
    ...
    function aa(obj) {
        var value = $(obj).attr("name"); // $(this)表示获取当前被点击元素的name值
        alert($("#"+value+"").serialize());
        $.ajax({
            type:'post',
            url:"<%=request.getContextPath()%>/JianLiController!addJianLi.do",
